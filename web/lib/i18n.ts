...
const dict = {
  ...
  // Admission profile / archive / transfer (§5.1, issue #27)
  'students.admit': { bn: 'ভর্তি করুন', en: 'Admit student' },
  'students.admissionForm': { bn: 'ভর্তি ফরম', en: 'Admission form' },
  'students.roll': { bn: 'রোল', en: 'Roll' },
  'students.edit': { bn: 'প্রোফাইল সম্পাদনা', en: 'Edit profile' },
  'students.secIdentity': { bn: 'পরিচয়', en: 'Identity' },
  'students.secPlacement': { bn: 'শ্রেণি ও শিফট', en: 'Class & shift' },
  'students.secAddress': { bn: 'ঠিকানা', en: 'Address' },
  'students.secGuardian': { bn: 'অভিভাবক', en: 'Guardian' },
  'students.secOther': { bn: 'অন্যান্য তথ্য', en: 'Other info' },
  'students.gender': { bn: 'লিঙ্গ', en: 'Gender' },
  'students.dob': { bn: 'জন্ম তারিখ', en: 'Date of birth' },
  'students.blood': { bn: 'রক্তের গ্রুপ', en: 'Blood group' },
  ...
  'students.guardianNid': { bn: 'অভিভাবকের এনআইডি', en: 'Guardian NID' },
  'students.prevInstitute': { bn: 'পূর্ববর্তী প্রতিষ্ঠান', en: 'Previous institute' },
  'students.prevClass': { bn: 'পূর্ববর্তী শ্রেণি', en: 'Previous class' },
  'students.siblings': { bn: 'ভাই-বোনের তথ্য', en: 'Sibling info' },
  'students.freedomFighter': { bn: 'মুক্তিযোদ্ধার সন্তান', en: 'Freedom Fighter child' },
  'students.indigenous': { bn: 'ক্ষুদ্র নৃগোষ্ঠী', en: 'Indigenous' },
  'students.photo': { bn: 'ছবি', en: 'Photo' },
  'students.uploadPhoto': { bn: 'ছবি আপলোড', en: 'Upload photo' },
  'students.imageOnly': { bn: 'শুধু ছবি ফাইল', en: 'Image files only' },
  'students.archive': { bn: 'আর্কাইভ (পুরনো শিক্ষার্থী)', en: 'Archive (Old Student)' },
  'students.restore': { bn: 'পুনরুদ্ধার', en: 'Restore' },
  'students.archived': { bn: 'পুরনো শিক্ষার্থী', en: 'Old Student' },
  'students.showArchived': { bn: 'পুরনো শিক্ষার্থী', en: 'Old Students' },
  'students.showActive': { bn: 'সক্রিয় শিক্ষার্থী', en: 'Active students' },
  'students.transfer': { bn: 'শ্রেণি/শিফট স্থানান্তর', en: 'Class/shift transfer' },
  'students.transferTo': { bn: 'নতুন', en: 'To' },
  'students.transferHistory': { bn: 'স্থানান্তরের ইতিহাস', en: 'Transfer history' },
  'students.noTransfers': { bn: 'কোনো স্থানান্তর নেই', en: 'No transfers' },
  'students.transferNote': { bn: 'মন্তব্য', en: 'Note' },
  'students.doTransfer': { bn: 'স্থানান্তর করুন', en: 'Transfer' },
  // Subject assignment + behaviour SMS + printables (§5.1, issue #46)
  'students.subjects': { bn: 'বিষয় নির্ধারণ', en: 'Subjects' },
  'students.assignSubject': { bn: 'বিষয় যোগ করুন', en: 'Assign subject' },
  'students.compulsory': { bn: 'আবশ্যিক', en: 'Compulsory' },
  'students.optional': { bn: 'ঐচ্ছিক', en: 'Optional' },
  'students.noSubjects': { bn: 'কোনো বিষয় নির্ধারিত নেই', en: 'No subjects assigned' },
  'students.markOptional': { bn: 'ঐচ্ছিক হিসেবে', en: 'As optional' },
  'students.subjectAssignment': { bn: 'শ্রেণিভিত্তিক বিষয় নির্ধারণ', en: 'Class subject assignment' },
  'students.bulkAssignIntro': { bn: 'একটি শ্রেণির সব শিক্ষার্থীকে একটি বিষয় নির্ধারণ করুন।', en: 'Assign a subject to every student in a class.' },
  'students.pickClass': { bn: 'শ্রেণি বাছাই করুন', en: 'Select a class' },
  'students.pickSubject': { bn: 'বিষয় বাছাই করুন', en: 'Select a subject' },
  'students.assignAll': { bn: 'সবাইকে নির্ধারণ করুন', en: 'Assign to all' },
  'students.assignedCount': { bn: 'জনকে নির্ধারণ করা হয়েছে', en: 'students assigned' },
  'students.sendSms': { bn: 'এসএমএস পাঠান', en: 'Send SMS' },
  'students.smsSent': { bn: 'এসএমএস পাঠানো হয়েছে', en: 'SMS sent' },
  'students.recentAvg': { bn: '৯০ দিনের গড়', en: '90-day avg' },
  'students.print': { bn: 'প্রিন্ট', en: 'Print' },
  'students.printAdmission': { bn: 'ভর্তি ফরম (পিডিএফ)', en: 'Admission form (PDF)' },
  'students.printId': { bn: 'আইডি কার্ড (পিডিএফ)', en: 'ID card (PDF)' },
  'common.save': { bn: 'সংরক্ষণ করুন', en: 'Save' },
  // School Owner dashboard
  'dash.subtitle': { bn: 'স্কুল ব্যবস্থাপনা ড্যাশবোর্ড', en: 'School management dashboard' },
  'dash.students': { bn: 'সক্রিয় শিক্ষার্থী', en: 'Active students' },
  'dash.employees': { bn: 'কর্মচারী', en: 'Employees' },
  'dash.attendanceToday': { bn: 'আজকের উপস্থিতি', en: "Today's attendance" },
  'dash.present': { bn: 'জন উপস্থিত', en: 'present' },
  'dash.subscription': { bn: 'সাবস্ক্রিপশন', en: 'Subscription' },
  'dash.noExpiry': { bn: 'মেয়াদ নেই', en: 'No expiry' },
  'dash.modules': { bn: 'মডিউলসমূহ', en: 'Modules' },
  'dash.recentAdmissions': { bn: 'সাম্প্রতিক ভর্তি', en: 'Recent admissions' },
  ...
  'dash.qaCollectFee': { bn: 'ফি সংগ্রহ', en: 'Collect fee' },
  ...
  'classes.addClass': { bn: 'নতুন শ্রেণি', en: 'New class' },
  ...
  'classes.addRoom': { bn: 'নতুন কক্ষ', en: 'New room' },
  'classes.capacity': { bn: 'ধারণক্ষমতা', en: 'Capacity' },
  'classes.noRooms': { bn: 'এখনো কোনো কক্ষ নেই', en: 'No rooms yet' },
  'classes.addSubject': { bn: 'নতুন বিষয়', en: 'New subject' },
  'classes.code': { bn: 'কোড', en: 'Code' },
  'classes.theory': { bn: 'তত্ত্বীয়', en: 'Theory' },
  'classes.mcq': { bn: 'নৈর্ব্যক্তিক', en: 'MCQ' },
